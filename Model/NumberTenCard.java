public class NumberTenCard extends NumberCard{
    ...
    public NumberTenCard(){
        /*super("\r\n" + //
                "Move a pawn ten spaces forward or one space back\r\n" + //
                "back. If none of a player's pawns can advance\r\n" + //
                "10 spaces forward, then a pawn must be moved\r\n" + //
                "back one position if of course such a move is possible.","TEN",10,"forward");*/
    }
    /**
